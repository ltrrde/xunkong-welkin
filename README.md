...
> 本项目是[寻空](https://github.com/xunkong/xunkong)的一个分支，修复自挪德卡莱版本以来由于停止维护出现的严重影响使用体验的bug。  
> - **元数据修复**：更换胡桃工具箱失效后的元数据来源（感谢 [wangdage12](https://github.com/wangdage12/Snap.Metadata/)）
> - **部分图片修复**：图鉴头图来源更换为与祈愿记录界面一致，其余部分依赖寻空服务器资源无法修复
> - **祈愿记录修复**：调整获取祈愿记录时的正则表达式，适配原神月之八更新后新的日志输出
